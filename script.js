window.addEventListener("load", function () {
    ...
    class InputHandler {
        constructor(game) {
            this.game = game;
            this.movementKeys = ["ArrowUp", "ArrowDown"];
            window.addEventListener("keydown", (ev) => {
                if (
                    this.movementKeys.includes(ev.key) &&
                    this.game.keys.indexOf(ev.key) === -1
                ) {
            ...
            window.addEventListener("keyup", (ev) => {
                if (this.game.keys.indexOf(ev.key) > -1) {
    ...
    class Player {
        ...
        shootTop() {
            ...
            if (this.powerUp) this.shotBottom();
        }
    ...
    class Angler1 extends Enemy {
        constructor(game) {
            super(game); // execute parent Enemy class constructor first   #
            this.width = 228;
            this.height = 169;
    ...
    class UI {
        ...
        draw(context) {
            ...
            for (let i = 0; i < this.game.ammo; i++) {
                context.fillRect(5 + 5 * i, 50, 3, 20);
            }
            context.restore();
        }
    }
